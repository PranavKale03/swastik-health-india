...
part '../../controllers/labTech_dashboard_controller.dart';
// models
...
class LabTechDashboardScreen extends GetView<LabTechDashboardController> {
  const LabTechDashboardScreen({Key? key}) : super(key: key);
  @override
